<?php
if (!class_exists('SMMGK_Update_Checker')) {

    class SMMGK_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'smmgk_plugin_updates';
